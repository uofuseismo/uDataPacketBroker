...
class uDataPacketCacheConan(ConanFile):
   ...
   #version = "0.0.1"
   license = "MIT"
   description = "A durable broker for seismic data packets."
   url = "https://github.com/uofuseismo/uDataPacketDataBroker"
   #topics = ("cache", "in-memory")
   ...
   def package_info(self):
       self.cpp_info.libs = ["uDataPacketDataBroker"]
